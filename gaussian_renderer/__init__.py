...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, separate_sh = False, override_color = None, use_trained_exp=False, pack=None):
    """
    Render the scene. 
    ...
    means3D, scales, rotations, opacity, features, features_dc, features_rest = pack
